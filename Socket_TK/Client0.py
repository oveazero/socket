...
class Client():
    def __init__(self):
        self.win = tkinter.Tk()
        self.win.title("客户端0")
        self.win.geometry("350x400+380+30")
    ...
    def initUI(self):
        ...
        button = tkinter.Button(self.win, text="启动",bd=0,font="黑体",bg="#39C45D", command=self.connectServer).grid(row=3, column=0)
        ...
        button2 = tkinter.Button(self.win, text="发送",font="黑体",bd=0,bg="#39C45D", command=self.sendMsg).grid(row=9, column=0)
        self.win.mainloop()
